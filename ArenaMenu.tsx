...
import { ArrowLeft, Zap, Skull } from 'lucide-react';
import { GameMode } from '../types';
import aimTrainerImage from 'figma:asset/e2918b978a9862a3e9a493a0b136a6415b60a7d7.png';
import sandboxImage from 'figma:asset/cd7d1274b5f4511855c5340fcdb5a85c2ee9bb8d.png';
...
export function ArenaMenu({ onStartGame, onBack }: ArenaMenuProps) {
  const [selectedMode, setSelectedMode] = useState<GameMode | null>(null);

  const arenaModes = [
    {
      id: 'arena_aim' as GameMode,
      title: 'AIM TRAINER',
    ...
    <div className="size-full flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl w-full px-6">
        ...
        >
          ...
          <h2 className="text-2xl font-mono text-secondary/80 mb-8">- ARENA -</h2>
        </motion.div>
