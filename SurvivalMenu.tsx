...
export function SurvivalMenu({ onStartGame, onBack }: SurvivalMenuProps) {
  const [selectedMode, setSelectedMode] = useState<GameMode | null>(null);

  const survivalModes = [
    {
      id: 'survival_single' as GameMode,
      title: 'SOLO',
      subtitle: 'QUICK JOIN',
      description: 'Fight alone',
      image: singlePlayerImage,
      tag: null
    },
    {
      id: 'survival_multiplayer' as GameMode,
      title: 'CO-OP',
      subtitle: 'SERVER BROWSER',
      description: 'Team survival',
    ...
    <div className="size-full flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl w-full px-6">
        ...
        >
          ...
          <h2 className="text-2xl font-mono text-secondary/80 mb-8">- SURVIVAL -</h2>
        </motion.div>

        {/* Game Mode Cards */}
        <div className="grid grid-cols-2 gap-16 mb-16">
          {survivalModes.map((mode, index) => (
            <motion.div
              key={mode.id}
